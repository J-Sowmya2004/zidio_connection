...
public class JobPostService {
    ...
    public JobPostDTO postJob(JobPostDTO dto){
        JobPost jobPost =new JobPost(dto.id,dto.jobTitle,dto.jobType
                ,dto.jobDescription,dto.jobLocation,dto.companyName
                ,dto.postedByEmail, (Data) dto.postedDate);
